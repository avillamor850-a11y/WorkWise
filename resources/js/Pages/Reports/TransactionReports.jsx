                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex space-x-2">
                        ...
                        <button
                            ...
                            className={isDark ? 'bg-gray-800 border border-gray-600 hover:bg-gray-700 text-gray-300 font-semibold py-2 px-4 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 text-sm flex items-center' : 'bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 font-semibold py-2 px-4 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 text-sm flex items-center'}
                        >
        ...
        >
            ...
            <div className={`relative py-12 overflow-hidden ${isDark ? 'bg-gray-900' : 'bg-white'}`}>
                ...
                <div className="relative z-20 max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                        ...
                        <div className={`backdrop-blur-sm overflow-hidden shadow-lg sm:rounded-xl ${isDark ? 'bg-gray-800 border border-gray-700' : 'bg-white border border-gray-200'}`}>
                            <div className="p-6">
                                <div className="flex items-center">
                                    ...
                                    <div className="ml-4">
                                        <div className={`text-sm font-medium ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>Total Volume</div>
                        ...
                        <div className={`backdrop-blur-sm overflow-hidden shadow-lg sm:rounded-xl ${isDark ? 'bg-gray-800 border border-gray-700' : 'bg-white border border-gray-200'}`}>
                            <div className="p-6">
                                <div className="flex items-center">
                                    ...
                                    <div className="ml-4">
                                        <div className={`text-sm font-medium ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>Total Transactions</div>
                                        <div className={`text-2xl font-bold ${isDark ? 'text-gray-100' : 'text-gray-900'}`}>
                        ...
                        <div className={`backdrop-blur-sm overflow-hidden shadow-lg sm:rounded-xl ${isDark ? 'bg-gray-800 border border-gray-700' : 'bg-white border border-gray-200'}`}>
                            <div className="p-6">
                                <div className="flex items-center">
                                    ...
                                    <div className="ml-4">
                                        <div className={`text-sm font-medium ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>Success Rate</div>
                                        <div className={`text-2xl font-bold ${isDark ? 'text-gray-100' : 'text-gray-900'}`}>
                        ...
                        <div className={`backdrop-blur-sm overflow-hidden shadow-lg sm:rounded-xl ${isDark ? 'bg-gray-800 border border-gray-700' : 'bg-white border border-gray-200'}`}>
                            <div className="p-6">
                                <div className="flex items-center">
                                    ...
                                    <div className="ml-4">
                                        <div className={`text-sm font-medium ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>Avg. Amount</div>
                                        <div className={`text-2xl font-bold ${isDark ? 'text-gray-100' : 'text-gray-900'}`}>
                    ...
                    <div className={`backdrop-blur-sm overflow-hidden shadow-lg sm:rounded-xl ${isDark ? 'bg-gray-800 border border-gray-700' : 'bg-white border border-gray-200'}`}>
                        <div className="p-8">
                            <h3 className={`text-lg font-medium mb-6 ${isDark ? 'text-gray-100' : 'text-gray-900'}`}>Transaction History</h3>
                                                ...
                                                <tr key={transaction.id} className={isDark ? 'hover:bg-gray-700' : 'hover:bg-gray-50'}>
                                                    ...
                                                    <td className="px-6 py-4 whitespace-nowrap">
                                                        <div className="flex items-center">
                                                            ...
                                                            <span className={`text-sm font-medium capitalize ${isDark ? 'text-gray-100' : 'text-gray-900'}`}>
                                                                {transaction.type}
                                                            </span>
                                                        </div>
                                                    </td>
