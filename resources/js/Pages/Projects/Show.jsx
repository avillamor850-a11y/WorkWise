    ...
    return (
        <div className="fixed inset-0 z-50 overflow-y-auto">
            <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div className={`inline-block align-bottom rounded-xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full border ${isDark ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}`}>
                    ...
                    <div className={`px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse border-t ${isDark ? 'bg-gray-800 border-gray-700' : 'bg-gray-50 border-gray-200'}`}>
                        ...
                        <button
                            ...
                            onClick={onClose}
                            disabled={isLoading}
                            className={`mt-3 w-full inline-flex justify-center rounded-md border shadow-sm px-4 py-2 focus:outline-none focus:ring-2 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm disabled:opacity-50 disabled:cursor-not-allowed ${isDark ? 'border-gray-600 bg-gray-800 text-gray-200 hover:bg-gray-700 focus:ring-offset-gray-900 focus:ring-gray-500' : 'border-gray-300 bg-white text-gray-700 hover:bg-gray-50 focus:ring-offset-white focus:ring-gray-500'}`}
                        >
                            Cancel
                        </button>
                    </div>
        ...
        >
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="lg:col-span-2 space-y-6">
                            ...
                            <div className={`overflow-hidden sm:rounded-xl border ${isDark ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200 shadow'}`}>
                                <div className="p-6">
                                    <h3 className={`text-lg font-semibold mb-4 ${isDark ? 'text-white' : 'text-gray-900'}`}>Project Overview</h3>
                                    <div className="prose prose-invert max-w-none">
                                        <p className={isDark ? 'text-gray-200' : 'text-gray-700'}>{project.job.description}</p>
                                    </div>
                                    
                                    <div className="mt-6 grid grid-cols-2 gap-4">
                                        <div>
                                            <dt className={`text-sm font-medium ${isDark ? 'text-gray-500' : 'text-gray-600'}`}>Required Skills</dt>
                                            <dd className="mt-1">
                                        ...
                                        <div>
                                            <dt className={`text-sm font-medium ${isDark ? 'text-gray-500' : 'text-gray-600'}`}>Experience Level</dt>
                                            <dd className={`mt-1 text-sm capitalize ${isDark ? 'text-white' : 'text-gray-900'}`}>{project.job.experience_level}</dd>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            {project.status === 'active' && (
                                <div className={`overflow-hidden sm:rounded-xl border ${isDark ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200 shadow'}`}>
                                    <div className="p-6">
                                        <h3 className={`text-lg font-semibold mb-4 ${isDark ? 'text-white' : 'text-gray-900'}`}>Project Actions</h3>
                                        <div className="flex flex-wrap gap-3">
                                            {!isEmployer && (
                                                <button
                                                    onClick={handleComplete}
                                                    className={`inline-flex items-center px-5 py-2.5 bg-green-600 hover:bg-green-500 border border-transparent rounded-lg font-medium text-sm text-white focus:outline-none focus:ring-2 focus:ring-green-500/50 focus:ring-offset-2 transition-colors duration-200 ${isDark ? 'focus:ring-offset-gray-900' : 'focus:ring-offset-white'}`}
                                                >
                                            ...
                                            {isEmployer && (
                                                <button
                                                    ...
                                                    className={`inline-flex items-center px-5 py-2.5 bg-amber-600 hover:bg-amber-500 border border-transparent rounded-lg font-medium text-sm text-white focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:ring-offset-2 transition-colors duration-200 ${isDark ? 'focus:ring-offset-gray-900' : 'focus:ring-offset-white'}`}
                                                >
                                                    <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            ...
                                            <button
                                                ...
                                                className={`inline-flex items-center px-5 py-2.5 bg-blue-600 hover:bg-blue-500 border border-transparent rounded-lg font-medium text-sm text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:ring-offset-2 transition-colors duration-200 ${isDark ? 'focus:ring-offset-gray-900' : 'focus:ring-offset-white'}`}
                                            >
                                                <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        {showCompletionForm && (
                                            <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
                                                <div className={`rounded-xl p-6 max-w-md w-full border ${isDark ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200 shadow-xl'}`}>
                                                    <h3 className={`text-lg font-semibold mb-4 ${isDark ? 'text-white' : 'text-gray-900'}`}>Complete Project</h3>
                                                    {completionError && (
                                                    ...
                                                    <form onSubmit={submitCompletion}>
                                                        <div className="mb-4">
                                                            ...
                                                            <textarea
                                                                ...
                                                                rows={4}
                                                                className={`w-full border rounded-md focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 ${isDark ? 'border-gray-600 bg-gray-700 text-gray-100 placeholder-gray-400' : 'border-gray-300 bg-white text-gray-900 placeholder-gray-500'}`}
                                                        ...
                                                        <div className="flex justify-end space-x-2">
                                                            <button
                                                                ...
                                                                className={`px-4 py-2 text-sm font-medium rounded-md focus:outline-none focus:ring-2 ${isDark ? 'text-gray-200 bg-gray-800 border border-gray-600 hover:bg-gray-700 focus:ring-offset-gray-900 focus:ring-gray-500' : 'text-gray-700 bg-white border border-gray-300 hover:bg-gray-50 focus:ring-offset-white focus:ring-gray-500'}`}
                                                            ...
                                                            <button
                                                                type="submit"
                                                                disabled={completionProcessing}
                                                                className={`inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 ${isDark ? 'focus:ring-offset-gray-900' : 'focus:ring-offset-white'}`}
                                                            >
                            ...
                            {project.status === 'completed' && (
                                <div className={`overflow-hidden sm:rounded-xl border ${isDark ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200 shadow'}`}>
                                    <div className="p-6">
                                        <h3 className={`text-lg font-semibold mb-4 ${isDark ? 'text-white' : 'text-gray-900'}`}>Project Completed</h3>
                                                ...
                                                <div className="ml-3">
                                                    ...
                                                    <div className={`mt-2 text-sm ${isDark ? 'text-gray-200' : 'text-gray-700'}`}>
                                                        ...
                                                        {!isEmployer && !project.employer_approved && !project.payment_released && autoReleaseDays > 0 && (
                                                            <p className={`mt-2 ${isDark ? 'text-amber-200/90' : 'text-amber-800'}`}>
                                                        ...
                                                        {project.completion_notes && (
                                                            <p className="mt-1"><strong className={isDark ? 'text-gray-100' : 'text-gray-900'}>Notes:</strong> {project.completion_notes}</p>
                                                        )}
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="flex flex-wrap gap-3">
                                            ...
                                            {isEmployer && !project.employer_approved && autoReleaseDays > 0 && (
                                                <p className={`text-sm mt-1 w-full ${isDark ? 'text-gray-500' : 'text-gray-600'}`}>
                                            ...
                                            <Link
                                                ...
                                                className={`inline-flex items-center px-5 py-2.5 rounded-lg font-medium text-sm focus:outline-none focus:ring-2 transition-colors duration-200 border ${isDark ? 'border-gray-600 bg-gray-800 text-gray-200 hover:bg-gray-700 focus:ring-gray-500 focus:ring-offset-gray-900' : 'border-gray-300 bg-white text-gray-700 hover:bg-gray-50 focus:ring-gray-500 focus:ring-offset-white'}`}
                                            >
                                                <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <div className={`mt-6 border-t pt-4 ${isDark ? 'border-gray-700' : 'border-gray-200'}`}>
                                            <h4 className={`text-sm font-medium mb-2 ${isDark ? 'text-gray-500' : 'text-gray-600'}`}>Project Timeline</h4>
                                            <div className="space-y-3">
                                                <div className="flex items-center text-sm">
                                                    <div className={`w-24 flex-shrink-0 ${isDark ? 'text-gray-500' : 'text-gray-600'}`}>Completed:</div>
                                                    <div className={isDark ? 'text-gray-200' : 'text-gray-700'}>{formatDistanceToNow(new Date(project.completed_at))} ago</div>
                                                </div>
                                                {project.employer_approved && (
                                                    <div className="flex items-center text-sm">
                                                        <div className={`w-24 flex-shrink-0 ${isDark ? 'text-gray-500' : 'text-gray-600'}`}>Approved:</div>
                                                        <div className={isDark ? 'text-gray-200' : 'text-gray-700'}>{formatDistanceToNow(new Date(project.approved_at))} ago</div>
                                                    </div>
                                                )}
                                                {project.payment_released && (
                                                    <div className="flex items-center text-sm">
                                                        <div className={`w-24 flex-shrink-0 ${isDark ? 'text-gray-500' : 'text-gray-600'}`}>Paid:</div>
                                                        <div className={isDark ? 'text-gray-200' : 'text-gray-700'}>{formatDistanceToNow(new Date(project.payment_released_at))} ago</div>
                                                    </div>
                                                )}
                                            </div>
                                        </div>
                            ...
                            {project.reviews && project.reviews.length > 0 && (
                                <div className={`overflow-hidden sm:rounded-xl border ${isDark ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200 shadow'}`}>
                                    <div className="p-6">
                                        <h3 className={`text-lg font-semibold mb-4 ${isDark ? 'text-white' : 'text-gray-900'}`}>Reviews</h3>
                                                ...
                                                <div key={review.id} className="border-l-4 border-blue-500 pl-4">
                                                    <div className="flex items-center justify-between mb-2">
                                                        ...
                                                        <div className="flex items-center">
                                                            {[...Array(5)].map((_, i) => (
                                                                <span key={i} className={`text-lg ${i < review.rating ? 'text-amber-400' : isDark ? 'text-gray-500' : 'text-gray-400'}`}>
                                                                    ★
                                                                </span>
                                                            ))}
                                                    ...
                                                    {review.comment && (
                                                        <p className={isDark ? 'text-gray-200' : 'text-gray-700'}>{review.comment}</p>
                                                    )}
                                                </div>
                                            ))}
                                        </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className={`overflow-hidden sm:rounded-xl border ${isDark ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200 shadow'}`}>
                                <div className="p-6">
                                    <h3 className={`text-lg font-semibold mb-4 ${isDark ? 'text-white' : 'text-gray-900'}`}>Project Details</h3>
                                    <dl className="space-y-3">
                                        <div>
                                            <dt className={`text-sm font-medium ${isDark ? 'text-gray-500' : 'text-gray-600'}`}>Project Value</dt>
                                            <dd className="text-lg font-semibold text-green-400">
                                                ₱{project.agreed_amount.toLocaleString()}
                                            </dd>
                                        </div>
                                        <div>
                                            <dt className={`text-sm font-medium ${isDark ? 'text-gray-500' : 'text-gray-600'}`}>Duration</dt>
                                            <dd className={`text-sm ${isDark ? 'text-gray-200' : 'text-gray-700'}`}>{project.agreed_duration_days} days</dd>
                                        </div>
                                        <div>
                                            <dt className={`text-sm font-medium ${isDark ? 'text-gray-500' : 'text-gray-600'}`}>Started</dt>
                                            <dd className={`text-sm ${isDark ? 'text-gray-200' : 'text-gray-700'}`}>
                                                {formatDistanceToNow(new Date(project.started_at))} ago
                                            </dd>
                                        </div>
                                        {project.deadline && (
                                            <div>
                                                <dt className={`text-sm font-medium ${isDark ? 'text-gray-500' : 'text-gray-600'}`}>Deadline</dt>
                                                <dd className={`text-sm ${isDark ? 'text-gray-200' : 'text-gray-700'}`}>
                                        ...
                                        {project.completed_at && (
                                            <div>
                                                <dt className={`text-sm font-medium ${isDark ? 'text-gray-500' : 'text-gray-600'}`}>Completed</dt>
                                                <dd className={`text-sm ${isDark ? 'text-gray-200' : 'text-gray-700'}`}>
                            ...
                            {hasPayment && (
                                <div className={`overflow-hidden sm:rounded-xl border ${isDark ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200 shadow'}`}>
                                    <div className="p-6">
                                        <h3 className={`text-lg font-semibold mb-4 ${isDark ? 'text-white' : 'text-gray-900'}`}>Payment Status</h3>
                                        <div className="space-y-2">
                                            <div className="flex items-center justify-between">
                                                <span className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>Escrow</span>
                                                <span className="text-sm font-medium text-green-400">✅ Secured</span>
                                            </div>
                                            <div className="flex items-center justify-between">
                                                <span className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>Payment</span>
                            ...
                            <div className={`overflow-hidden sm:rounded-xl border ${isDark ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200 shadow'}`}>
                                <div className="p-6">
                                    ...
                                    <div className="space-y-2">
                                        <button
                                            onClick={() => handleSendMessage(isEmployer ? project.gig_worker.id : project.employer.id)}
                                            className={`flex items-center w-full text-left px-4 py-3 text-sm font-medium rounded-lg border transition-colors duration-200 ${isDark ? 'text-gray-200 hover:bg-gray-700 hover:text-gray-100 border-gray-700 hover:border-blue-500/30' : 'text-gray-700 hover:bg-gray-50 border-gray-200 hover:border-blue-200'}`}
                                        >
                                        ...
                                        <Link
                                            href="/payment/history"
                                            className={`flex items-center w-full text-left px-4 py-3 text-sm font-medium rounded-lg border transition-colors duration-200 ${isDark ? 'text-gray-200 hover:bg-gray-700 hover:text-gray-100 border-gray-700 hover:border-gray-600' : 'text-gray-700 hover:bg-gray-50 border-gray-200 hover:border-gray-200'}`}
                                        >
                                            <svg className={`w-5 h-5 mr-3 ${isDark ? 'text-gray-500' : 'text-gray-400'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" />
                                            </svg>
                                            Payment History
                                        </Link>
                                        <Link
                                            ...
                                            className={`flex items-center w-full text-left px-4 py-3 text-sm font-medium text-red-400 hover:bg-red-500/10 hover:text-red-300 rounded-lg border transition-colors duration-200 ${isDark ? 'border-gray-700 hover:border-red-500/30' : 'border-gray-200 hover:border-red-300'}`}
                                        >
            ...
            {showReviewForm && (
                <div className="fixed inset-0 bg-black/50 backdrop-blur-sm overflow-y-auto h-full w-full z-50 flex items-center justify-center p-4">
                    <div className={`relative w-full max-w-md p-6 border shadow-xl rounded-xl ${isDark ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}`}>
                        <div>
                            <h3 className={`text-lg font-medium mb-4 ${isDark ? 'text-white' : 'text-gray-900'}`}>Leave a Review</h3>
                            <form onSubmit={submitReview}>
                                    ...
                                    <div className="flex items-center space-x-1">
                                        {[1, 2, 3, 4, 5].map((rating) => (
                                            <button
                                                ...
                                                className={`text-2xl ${rating <= data.rating ? 'text-amber-400' : isDark ? 'text-gray-500' : 'text-gray-400'} hover:text-amber-400`}
                                            >
                                                ★
                                            </button>
                                        ))}
                                ...
                                <div className="flex justify-end space-x-3">
                                    <button
                                        ...
                                        className={`px-4 py-2 text-sm font-medium rounded-md ${isDark ? 'text-gray-200 bg-gray-800 border border-gray-600 hover:bg-gray-700' : 'text-gray-700 bg-white border border-gray-300 hover:bg-gray-50'}`}
                                    >
                                        Cancel
                                    </button>
                                    <button
            ...
            {showRevisionForm && (
                <div className="fixed inset-0 bg-black/50 backdrop-blur-sm overflow-y-auto h-full w-full z-50 flex items-center justify-center p-4">
                    <div className={`relative w-full max-w-md p-6 border shadow-xl rounded-xl ${isDark ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}`}>
                        <div>
                            <h3 className={`text-lg font-medium mb-4 ${isDark ? 'text-white' : 'text-gray-900'}`}>Request Revision</h3>
                    ...
                    <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                        ...
                        <div className={`inline-block align-bottom rounded-xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full border ${isDark ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}`}>
                            <div className="px-4 pt-5 pb-4 sm:p-6">
                                <h3 className={`text-lg font-medium ${isDark ? 'text-white' : 'text-gray-900'}`}>Request admin review</h3>
                                <p className={`mt-2 text-sm ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>An admin can approve completion and release your payment if the employer has not responded. Optional: add notes for the admin.</p>
                                <div className="mt-4">
                                    <textarea
                                        ...
                                        rows={3}
                                        className={`mt-1 block w-full rounded-lg border px-3 py-2 focus:border-amber-500/50 focus:ring-1 focus:ring-amber-500/50 sm:text-sm ${isDark ? 'border-gray-700 bg-gray-800 text-gray-100 placeholder-gray-400' : 'border-gray-300 bg-white text-gray-900 placeholder-gray-500'}`}
                                        maxLength={1000}
                                    />
                                </div>
                            </div>
                            <div className={`px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse border-t gap-3 ${isDark ? 'bg-gray-800 border-gray-700' : 'bg-gray-50 border-gray-200'}`}>
                                <button
                                    type="button"
                                    onClick={submitAdminReviewRequest}
                                    disabled={adminReviewProcessing}
                                    className={`w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-amber-600 hover:bg-amber-500 text-white text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500 sm:w-auto disabled:opacity-50 ${isDark ? 'focus:ring-offset-gray-900' : 'focus:ring-offset-white'}`}
                                >
                                ...
                                <button
                                    ...
                                    disabled={adminReviewProcessing}
                                    className={`mt-3 w-full inline-flex justify-center rounded-md border px-4 py-2 text-sm font-medium sm:mt-0 sm:w-auto disabled:opacity-50 ${isDark ? 'border-gray-600 bg-gray-800 text-gray-200 hover:bg-gray-700' : 'border-gray-300 bg-white text-gray-700 hover:bg-gray-50'}`}
                                >
                                    Cancel
                                </button>
                            </div>
