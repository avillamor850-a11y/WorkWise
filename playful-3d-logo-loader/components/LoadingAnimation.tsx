    ...
    <div className="flex items-center justify-center min-h-screen bg-transparent">
      ...
      >
        ...
        >
          ...
          {/* The "W" Ribbon Segments */}
          <g>
            {/* Segment 1: Left Outer Arm */}
            <motion.path
            ...
            {/* Segment 2: Left Inner Arm (Shadow) */}
            <motion.path
